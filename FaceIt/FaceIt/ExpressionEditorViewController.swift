...
//  FaceIt
//
//  Created by Németh Bendegúz on 2017. 08. 31..
...
class ExpressionEditorViewController: UITableViewController, UITextFieldDelegate {
    ...
    func handleUnnamedFace() {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { action in
            ...
            if self.shouldPerformSegue(withIdentifier: "Add Emotion", sender: nil) {
        ...
        alert.textFields?.first?.attributedPlaceholder = NSAttributedString(string: "Name")
